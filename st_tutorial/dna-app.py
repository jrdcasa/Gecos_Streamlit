...
# https://github.com/vanleiko/dna-streamlit/blob/main/src/app-dna-v2.py
    ...
    if input_seq1 and input_seq2:
        ...
        if eh_dna(seq1) and eh_dna(seq2):
            ...
            if tipo_alinhamento == "Global":
                ...
                match, mismatch, gap, score_final, ali_seq1, ali_seq2 = alinhamento_global(seq1, seq2, matriz_caminho,
                                                                                           matriz_subs)

            elif tipo_alinhamento == "Local":
                matriz_pontuacao, matriz_caminho = lcs_local(seq1, seq2, matriz_subs)
                match, mismatch, gap, score_final, ali_seq1, ali_seq2 = alinhamento_local(seq1, seq2, matriz_pontuacao,
                                                                                          matriz_caminho, matriz_subs)
